...
def check_pwd():
    ...
    if strength == 1:
        ...
        remarks = "A Weak Password, Consider Changing"
    elif strength == 4:
        remarks = "A Hard Password, but can be better"
    elif strength == 5:
...
if __name__ == '__password_checker__':
    print('+++ WELCOME TO DANNYS PASSWORD CHECKER +++')
    ask_pwd = ask_pwd()
    while check_pwd:
        check_pwd()
